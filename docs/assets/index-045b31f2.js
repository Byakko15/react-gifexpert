...
function Ji(e, n, t) {
  ...
  if (n != null)
    ...
    n))
      Xi.call(n, r) && !Zi.hasOwnProperty(r) && (l[r] = n[r]);
  ...
  return {$$typeof: Gt, type: e, key: u, ref: o, props: l, _owner: Au.current};
}
function hc(e, n) {
  return {
    $$typeof: Gt,
  ...
  function E(C, N) {
    ...
    try {
      ...
      if (m !== null) var bt = !0;
        ...
        var yn = t(c);
        yn !== null && yl(v, yn.startTime - N), (bt = !1);
      }
      return bt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function vs() {
  if (Yn) {
    var e = Yn,
      n = Gn;
    if (((Gn = Yn = null), Wo(e), n)) for (e = 0; e < n.length; e++) Wo(n[e]);
  }
}
function ys(e, n) {
  return e(n);
...
function Uc(e, n, t, r, l, u, o, i, s) {
  (Ct = !1), (Rr = null), jc.apply(Fc, arguments);
}
...
function qu(e, n, t, r) {
  if (Dr) {
    var l = cu(e, n, t, r);
    if (l === null) Il(e, n, r, jr, t), Yo(e, r);
...
function Lf(e, n) {
  if (jn)
    return e === "compositionend" || (!to && js(e, n))
      ? ((e = Is()), (kr = bu = en = null), (jn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function vn() {
  if (!jl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Cs(Xu, vn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
function Cu(e, n, t, r) {
  ...
  typeof u == "object" && u !== null
    ? (l.context = _e(u))
    : ((u = de(n) ? Pn : le.current), (l.context = bn(e, u))),
...
function oa(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (P === d.length) return t(f, x), F && wn(f, P), E;
    if (x === null) {
      for (; P < d.length; P++)
        (x = m(f, d[P], v)),
          x !== null &&
  ...
  function S(f, a, d, v) {
    ...
    if (T.done) return t(f, x), F && wn(f, P), E;
    if (x === null) {
...
function nd(e, n, t) {
  ...
  if (xa(e)) Pa(n, l);
    ...
    (t = ta(e, n, l, r)),
      t !== null && ((l = oe()), Oe(t, e, r, l), Na(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && t && lo(n), (n.flags |= 1), ue(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && r && lo(n), (n.flags |= 1), ue(e, n, t, l), n.child)
  );
}
function Li(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Pr(e, n), ua(n, t, r), Cu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Ti(e, n, t, r, l) {
  return et(), oo(l), (n.flags |= 256), ue(e, n, t, r), n.child;
}
...
function Ia(e, n, t) {
  ...
  if (u) {
    ...
    return (
      ...
      i !== null ? (u = fn(i, u)) : ((u = xn(u, o, t, null)), (u.flags |= 2)),
      (u.return = n),
      (r.return = n),
      (r.sibling = u),
      (n.child = r),
...
function ad(e, n, t) {
  ...
  switch ((uo(n), n.tag)) {
    ...
    case 4:
      return (
        tt(), Lu(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null
      );
    case 10:
    ...
    case 17:
      return de(n.type) && $r(), te(n), null;
    case 19:
      if ((D(U), (u = n.memoizedState), u === null)) return te(n), null;
...
function dd(e, n) {
  ...
  for (mu = {focusedElem: e, selectionRange: t}, Dr = !1, k = n; k !== null; )
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[je], delete n[Vt], delete n[yu], delete n[Gf], delete n[Xf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Wa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    R |= 2;
    var u = Ka();
    (Z !== e || b !== n) && (($e = null), (lt = W() + 500), _n(e, n));
    do
      try {
        yd();
        break;
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = su(e)), l !== 0 && ((r = l), (n = ju(e, l)))), n === 1)
    )
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = vu(Sn.bind(null, e, ae, $e), n);
            break;
          }
          Sn(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = vu(Sn.bind(null, e, ae, $e), r);
            break;
          }
          Sn(e, ae, $e);
          break;
...
function No() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(Ln & 268435455) && !(cl & 268435455)) || be(Z, b);
}
function qr(e, n) {
  var t = R;
  R |= 2;
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Cu(n, r, e, t),
            (n = Pu(null, n, r, !0, u, t)))
          : ((n.tag = 0), F && u && lo(n), ue(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zu(n, t | 1), pe(n, W()), !(R & 6) && ((lt = W() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = xo;
gs = Tn;
var zd = {usingClientEntryPoint: !1, Events: [Jt, $n, ul, hs, vs, xo]},
  yt = {
...
const Rd = ({newCategory: e}) => {
    const [n, t] = tn.useState(""),
      r = (u) => {
        t(u.target.value);
      },
      l = (u) => {
        u.preventDefault(), !(n.trim().length <= 1) && (e(n.trim()), t(""));
      };
    return q.jsx("form", {
      onSubmit: l,
  ...
  Od = async (e) => {
    const l = await fetch(
        `https://api.giphy.com/v1/gifs/search?api_key=iA945auGmVdql0kKFNygGsgX4Rq03IVr&q=${e}&limit=5`
      ),
      {data: u} = await l.json();
    return u.map((i) => ({
      id: i.id,
  ...
  Id = ({title: e, url: n}) =>
    q.jsxs("div", {
      children: [q.jsx("h2", {children: e}), q.jsx("img", {src: n, alt: e})],
    }),
  Dd = ({category: e}) => {
    const {images: n, loading: t} = Md(e);
    return q.jsxs("div", {
      children: [
        q.jsx("h3", {children: e}),
        t && q.jsx("h2", {children: "Cargando..."}),
        n == null ? void 0 : n.map((r) => q.jsx(Id, {...r}, r.id)),
      ],
    });
  };
function jd() {
  const [e, n] = tn.useState([]),
    t = (r) => {
      e.includes(r) || n([...e, r]);
    };
  return q.jsxs(q.Fragment, {
    children: [
      q.jsx("h1", {children: "Gifs App"}),
      q.jsx("h5", {children: "By Byakko15"}),
      q.jsx(Rd, {newCategory: t}),
      e.map((r) => q.jsx(Dd, {category: r}, r)),
    ],
  });
}
Ql.createRoot(document.getElementById("root")).render(
  q.jsx(wc.StrictMode, {children: q.jsx(jd, {})})
);
